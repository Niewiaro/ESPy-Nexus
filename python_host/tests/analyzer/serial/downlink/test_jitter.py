...
class TestCalculateJitter:
    ...
    def test_jitter_perfect_intervals(self):
        ...
        result = calculate_jitter(esp_timestamps)
    ...
    def test_jitter_insufficient_data(self):
        ...
        """
        res_empty = calculate_jitter(pd.Series([], dtype=float))
        res_single = calculate_jitter(pd.Series([123456]))
    ...
    def test_jitter_two_packets(self):
        ...
        Std should be 0, as there is no variability between intervals.
        """
        # One interval: 15000
