...
\usepackage[pdftex,
            pdfauthor={Jakub Biernat - twórca templatki},
            pdftitle={Temat pracy dyplomowej w języku polskim},
            pdfsubject={Temat pracy dyplomowej w języku angielskim}]{hyperref}  % UStawienie parametrów dokumentu pdf
