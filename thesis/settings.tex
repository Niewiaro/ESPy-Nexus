\usepackage[top=2.5cm,bottom=2.5cm,inner=3.5cm,outer=2.5cm,a4paper,twoside]{geometry} % Page margins
...
% --- ZAPOBIEGANIE BĘKARTOM I SIEROTOM ---
\babelprovide[transforms = orphans]{polish} 
\clubpenalty=10000
\widowpenalty=10000
\displaywidowpenalty=10000

% --- BRAK DZIELENIA WYRAZÓW I TOLERANCJA SPACJI ---
...
\usepackage[newfloat=true,cache=true]{minted} % Code blocks with floating listing support
